...
public class AttendanceUploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadUrl = AppSettings.getValue(this, AppSettings.PREF_LOCAL_IP, "192.168.31.1");
    ...
    private void uploadImage() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, uploadUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Toast.makeText(AttendanceUploadActivity.this, response, Toast.LENGTH_LONG).show();
        ...
        stringRequest.setRetryPolicy(new DefaultRetryPolicy(40 * 10000, 0,
                0));
        MySingleton.getInstance(AttendanceUploadActivity.this).addToRequestQue(stringRequest);
    }
